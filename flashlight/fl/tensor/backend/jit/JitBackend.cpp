...
Tensor JitBackend::randn(const Shape& shape, dtype type) {
  return jitTensorCreator_(CustomNode::create(
      "randn", tensorsToNodes(), Shape(shape), [=](auto /* inputs */) {
...
Tensor JitBackend::rand(const Shape& shape, dtype type) {
  return jitTensorCreator_(CustomNode::create(
      "rand", tensorsToNodes(), Shape(shape), [=](auto /* inputs */) {
...
JitBackend::arange(const Shape& shape, const Dim seqDim, const dtype type) {
  return jitTensorCreator_(CustomNode::create(
      "arange", tensorsToNodes(), Shape(shape), [=](auto /* inputs */) {
...
Tensor JitBackend::reshape(const Tensor& tensor, const Shape& shape) {
  return jitTensorCreator_(CustomNode::create(
      "reshape", tensorsToNodes(tensor), Shape(shape), [=](auto inputs) {
...
Tensor JitBackend::transpose(const Tensor& tensor, const Shape& axes = {}) {
  ...
  return jitTensorCreator_(CustomNode::create(
      "transpose", tensorsToNodes(tensor), Shape(newShape), [=](auto inputs) {
...
Tensor JitBackend::pad(
  ...
  return jitTensorCreator_(CustomNode::create(
      "pad", tensorsToNodes(input), Shape(outputDims), [=](auto inputs) {
...
#define FL_JIT_BACKEND_UNARY_FALLBACK_IMPL(OP)                                 \
  {                                                                            \
    return jitTensorCreator_(CustomNode::create(                               \
        #OP, tensorsToNodes(tensor), Shape(tensor.shape()), [=](auto inputs) { \
...
Tensor JitBackend::flip(const Tensor& tensor, const unsigned dim) {
  return jitTensorCreator_(CustomNode::create(
      "flip", tensorsToNodes(tensor), Shape(tensor.shape()), [=](auto inputs) {
...
JitBackend::roll(const Tensor& tensor, const int shift, const unsigned axis) {
  return jitTensorCreator_(CustomNode::create(
      "roll", tensorsToNodes(tensor), Shape(tensor.shape()), [=](auto inputs) {
...
JitBackend::sort(const Tensor& input, const Dim axis, const SortMode sortMode) {
  return jitTensorCreator_(CustomNode::create(
      "sort", tensorsToNodes(input), Shape(input.shape()), [=](auto inputs) {
...
Tensor JitBackend::argsort(
    ...
    const SortMode sortMode) {
  return jitTensorCreator_(CustomNode::create(
      "argsort", tensorsToNodes(input), Shape(input.shape()), [=](auto inputs) {
...
#define FL_JIT_BACKEND_BINARY_FALLBACK_IMPL(OP)                               \
  {                                                                           \
    ...
    return jitTensorCreator_(CustomNode::create(                              \
        #OP, tensorsToNodes(lhs, rhs), Shape(lhs.shape()), [=](auto inputs) { \
...
Tensor JitBackend::matmul(
  ...
  return jitTensorCreator_(CustomNode::create(
      "matmul", tensorsToNodes(lhs, rhs), Shape(outputShape), [=](auto inputs) {
...
Tensor JitBackend::cumsum(const Tensor& input, const unsigned axis) {
  return jitTensorCreator_(CustomNode::create(
      "cumsum", tensorsToNodes(input), Shape(input.shape()), [=](auto inputs) {
